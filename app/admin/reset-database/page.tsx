            ...
            <CardContent className="pt-6">
              <Alert className="border-green-200 bg-green-50">
                ...
                <AlertDescription className="text-green-800">
                  ...
                  <div className="mt-2">
                    <p>✅ {result.data?.users || 0} Regular Users created</p>
                    <p>✅ {result.data?.vendors || 0} Vendors created</p>
                    <p>✅ {result.data?.weddingPlanners || 0} Wedding Planners created</p>
                    <p>✅ {result.data?.admins || 0} Admins created</p>
                    <p>✅ All {result.data?.totalCollections || 0} collections populated</p>
                  </div>
                </AlertDescription>
              </Alert>
            </CardContent>
