...
test.describe('Booking System', () => {
  ...
  test.skip('DISABLED: Booking status tracking', async ({ page }) => {
    ...
    const timelineCount = await page.locator('.timeline-item, [data-testid="timeline-item"]').count();
  ...
  test.skip('DISABLED: Booking communication and messaging', async ({ page }) => {
    ...
    const messageCount = await page.locator('.message-item, [data-testid="message-item"]').count();
