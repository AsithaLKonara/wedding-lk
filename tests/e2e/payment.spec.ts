...
test.describe('Payment System', () => {
  ...
  test.skip('DISABLED: Payment history and analytics', async ({ page }) => {
    ...
    const paymentCount = await page.locator('.payment-item, [data-testid="payment-item"]').count();
    ...
    const filteredCount = await page.locator('.payment-item, [data-testid="payment-item"]').count();
