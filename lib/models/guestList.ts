...
GuestListSchema.methods.updateStatistics = function() {
  const guests = this.guests as any[];
  
  this.statistics.totalInvited = guests.length;
  this.statistics.totalAttending = guests.filter((g: any) => g.rsvpStatus === 'attending').length;
  this.statistics.totalNotAttending = guests.filter((g: any) => g.rsvpStatus === 'not_attending').length;
  this.statistics.totalPending = guests.filter((g: any) => g.rsvpStatus === 'pending').length;
  this.statistics.totalPlusOnes = guests.filter((g: any) => g.isPlusOne).length;
