...
export const MetaAdsCampaign = mongoose.models.MetaAdsCampaign || mongoose.model<IMetaAdsCampaign>('MetaAdsCampaign', MetaAdsCampaignSchema);
export const MetaAdsAdSet = mongoose.models.MetaAdsAdSet || mongoose.model<IMetaAdsAdSet>('MetaAdsAdSet', MetaAdsAdSetSchema);
export const MetaAdsCreative = mongoose.models.MetaAdsCreative || mongoose.model<IMetaAdsCreative>('MetaAdsCreative', MetaAdsCreativeSchema);
export const MetaAdsAccount = mongoose.models.MetaAdsAccount || mongoose.model<IMetaAdsAccount>('MetaAdsAccount', MetaAdsAccountSchema);
