...
// Error classes for API error handling
...
export function handleError(error: any): { success: false; error: { code: string; message: string; details?: any; timestamp: string; requestId: string } } {
...
// Request ID generator (already defined above, removed duplicate)
