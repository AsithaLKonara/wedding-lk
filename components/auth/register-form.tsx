    ...
    <Card className="w-full max-w-md mx-auto">
      ...
      <CardContent>
        ...
        <div className="flex gap-4 mb-6">
          <Button variant="outline" className="w-full" onClick={() => toast({ title: "Google sign up", description: "Coming soon" })}>Sign up with Google</Button>
          <Button variant="outline" className="w-full" onClick={() => toast({ title: "Facebook sign up", description: "Coming soon" })}>Sign up with Facebook</Button>
        </div>
