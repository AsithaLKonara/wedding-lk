            ...
            <Input
              ...
              onChange={(e) => setFormData({
                ...
                pricing: { 
                  ...
                  isNegotiable: formData.pricing?.isNegotiable || false,
                  ...formData.pricing
                }
              })}
              placeholder="0.00"
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) => setFormData({
                ...formData,
                availability: { 
                  isAvailable: formData.availability?.isAvailable ?? true,
                  availableFrom: formData.availability?.availableFrom || new Date().toISOString(),
                  maxBookings: parseInt(e.target.value) || 1,
                  currentBookings: formData.availability?.currentBookings || 0,
                  advanceBookingDays: formData.availability?.advanceBookingDays || 30,
            ...
            <Input
              ...
              onChange={(e) => setFormData({
                ...
                availability: { 
                  isAvailable: formData.availability?.isAvailable ?? true,
                  availableFrom: formData.availability?.availableFrom || new Date().toISOString(),
                  maxBookings: formData.availability?.maxBookings || 1,
                  currentBookings: formData.availability?.currentBookings || 0,
            ...
            <Input
              ...
              onChange={(e) => setFormData({
                ...
                requirements: { 
                  ...
                  maxGuests: formData.requirements?.maxGuests || 1000,
                  venueRequirements: formData.requirements?.venueRequirements || [],
                  equipmentProvided: formData.requirements?.equipmentProvided || [],
                  equipmentRequired: formData.requirements?.equipmentRequired || [],
                  setupTime: formData.requirements?.setupTime || 0,
                  breakdownTime: formData.requirements?.breakdownTime || 0,
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) => setFormData({
                ...formData,
                requirements: { 
                  minGuests: formData.requirements?.minGuests || 1,
                  maxGuests: parseInt(e.target.value) || 1000,
                  venueRequirements: formData.requirements?.venueRequirements || [],
                  equipmentProvided: formData.requirements?.equipmentProvided || [],
                  equipmentRequired: formData.requirements?.equipmentRequired || [],
                  setupTime: formData.requirements?.setupTime || 0,
